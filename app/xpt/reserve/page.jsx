...
export const metadata = { title: 'XPT Reservation' };

const XPT_PAYMENT_LINK = programCheckoutConfig.XPT.paymentLink;
...
export default function XptReservePage() {
  return (
    <>
      <PageHero
        eyebrow="XPT Reservation"
      ...
      <section className="section section-glow-sides">
        <div className="container" style={{ display: 'grid', gap: '1.5rem' }}>
          ...
          >
            ...
            <h3>Reserve your XPT session in two steps.</h3>
          ...
          >
            ...
            <h3>XPT reservation form</h3>
            <p className="price-note">
              Submit the waiver first. After that, a confirmation popup will guide you to payment.
            </p>

            <ProgramReservationForm
              formType="XPT Reservation"
              programCode="XPT"
              reservationLabel="XPT reservation"
              paymentLink={XPT_PAYMENT_LINK}
            />

            <div className="btn-row spacer-top">
              <Link href="/xpt" className="btn" style={goldOutlineBtn}>
                Back to XPT
              </Link>
            </div>
          </div>
